...
(0102,"班級活動","四-08","四-09",NULL,"會計","張森河",0,60,TRUE),
(0103,"科學與人文的對話","四-03","四-04",NULL,"會計","宋明弘",2,64,TRUE),
(0104,"體育(二)","三-03","三-04",NULL,"會計","吳佩伊",1,60,TRUE),
(0105,"商業軟體應用","三-01","三-02",NULL,"會計","謝育龍",2,60,TRUE),
(0106,"會計學(二)","二-06","二-07","二-08","會計","張森河",3,60,TRUE),
(0107,"會計學(二)實習","三-08","三-09",NULL,"會計","廖盈芳",0,60,TRUE),
(0108,"經濟學(二)","二-02","二-03","二-04","會計","彭德昭",3,65,TRUE),
(0109,"經濟學(二)實習","五-03","五-04",NULL,"會計","黃于凌",0,65,TRUE),
(0118,"公司及票據法","一-06","一-07","一-08","會計","袁義昕",3,62,FALSE),
(1672,"班級活動","一-08","一-09",NULL,"自控","謝男凱",0,63,TRUE),
(1673,"體育(二)","三-06","三-07",NULL,"自控","劉嘉豪",1,60,TRUE),
(1674,"現代公民與社會實踐","四-06","四-07",NULL,"自控","林文謙",2,63,TRUE),
(1677,"程式設計","二-01","二-02","三-03","自控","秦群立",3,64,TRUE),
(1678,"程式設計實習","二-08","二-09","二-10","自控","秦群立",1,62,TRUE),
(1681,"邏輯設計","一-04","三-01","三-02","自控","謝男凱",3,75,TRUE),
(1700,"動力學","二-06","五-03","五-04","自控","鄒慶福",3,60,TRUE);

INSERT INTO student
VALUES (1,"陳一二","資訊",19,25),
(2,"林三四","會計",19,25),
(3,"吳五六","自控",19,25);

INSERT INTO choosen(student_id,student)
VALUES(1,"陳一二"),
(2,"林三四"),
(3,"吳五六");